...
# Source folder
source_folder = r"G:\My Drive\algo-film\delenda_algo_film_shoot_0822\_warp_sd\_dan_comp\03_segment_38_stable_warpfusion_0.23.0_\upsclae"

# Output folder
output_folder = r"G:\My Drive\algo-film\delenda_algo_film_shoot_0822\_warp_sd\_dan_comp\_output_videos"
...
for file_pattern in file_patterns:
    ...
    # Create a new list of filenames for the forward and backward sequence
    # Exclude the last image when creating the looped sequence
    looped_filenames = filenames + filenames[-2::-1]

    # Make a clip out of these images
    clip = ImageSequenceClip(looped_filenames, fps=24)
